...
import com.hanzi.videobinddemo.VideoInfo;
...
import com.hanzi.videobinddemo.MediaBean;
...
public class TestVideoDrawer implements GLSurfaceView.Renderer {

    private static final String TAG = TestVideoDrawer.class.getSimpleName();
...
//    private final GroupFilter mGroupFilter;
    ...
    public TestVideoDrawer(Context context, Resources res, boolean isBinding) {
...
//
        ...
        mShow.setTextureId(fTexture[0]);//mRotationOESFilter.getOutputTexture());
        mShow.draw();
        if (!isBinding) {
            caculateFrameRate();
        }
